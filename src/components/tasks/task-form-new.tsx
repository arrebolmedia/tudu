            ...
            >
              ...
              <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-between">
                ...
                <button
                  ...
                  disabled={!title.trim()}
                  className="px-4 py-2 text-sm font-medium text-white bg-arrebol-terracota-500 hover:bg-arrebol-terracota-600 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors duration-200 flex items-center gap-2 font-display"
                >
