 ...
 * Versión simplificada para gestión de roles
 */
...
const mockRoles = [
  ...
  },
  {
    id: 'coordinador',
    name: 'Coordinador',
    description: 'Event coordinator with assigned client view access',
    isSystem: true,
    usersCount: 4
  },
  {
...
const roleDescriptions = {
  ...
  Coordinador: {
    description: 'Coordinador de eventos con acceso limitado a clientes asignados.',
    permissions: [
      'Solo visualización de eventos asignados',
      'No puede editar información',
      'Acceso de solo lectura a datos del cliente',
      'No puede eliminar registros',
      'Seguimiento de su cartera asignada'
    ],
    color: 'secondary' as const,
    icon: '👥'
  },
...
export function SimpleRolesManagement() {
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="text-sm text-gray-500">
              {mockRoles.length} roles configurados
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-3 text-sm">
            <div className="flex items-center space-x-3 flex-wrap">
              ...
              <span className="text-gray-500">→</span>
              <Badge variant="outline">Vendedor, GerenteBanquetes, Coordinador, Planner</Badge>
            </div>
