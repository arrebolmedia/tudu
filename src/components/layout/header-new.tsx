...
import { Heart, Sparkles, User, LogOut, Settings } from 'lucide-react'
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1">
                  <Sparkles className="h-4 w-4 text-arrebol-terracota-400 animate-pulse" />
                </div>
              </div>
            </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-2 shadow-xl backdrop-blur-xl">
                      ...
                      <div className="py-1">
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 text-sm"
                        >
                          <User className="w-4 h-4" />
                          <span>Mi Perfil</span>
                        </button>
                        
                        <button className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 text-sm">
